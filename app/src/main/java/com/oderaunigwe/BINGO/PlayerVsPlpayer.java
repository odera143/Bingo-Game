...
public class PlayerVsPlpayer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private ArrayList<Integer> vals = new ArrayList<Integer>();
    private ArrayList<Integer> vals_P2 = new ArrayList<Integer>();
    private ArrayList<Integer> pickPool = new ArrayList<Integer>();
    private int[][] table = new int [5][5];
    private int[][] table_P2 = new int[5][5];
    private int pick;
    private int bound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_vs_plpayer);
    ...
    {   bound = 74;
        ...
        changeBingoColorP2(view,R.color.greyedOut);
        fill_pickPool();
        vals.clear();
        vals_P2.clear();
    ...
    public void newCardP2(View view)
    {
        char b = 'b', i = 'i', n = 'n', g = 'g', o = 'o';
        string_to_int(view,vals_P2,R.id.b01,b);
        string_to_int(view,vals_P2,R.id.i01,i);
        string_to_int(view,vals_P2,R.id.n01,n);
        string_to_int(view,vals_P2,R.id.g01,g);
        string_to_int(view,vals_P2,R.id.o01,o);
        string_to_int(view,vals_P2,R.id.b02,b);
        string_to_int(view,vals_P2,R.id.i02,i);
        string_to_int(view,vals_P2,R.id.n02,n);
        string_to_int(view,vals_P2,R.id.g02,g);
        string_to_int(view,vals_P2,R.id.o02,o);
        string_to_int(view,vals_P2,R.id.b03,b);
        string_to_int(view,vals_P2,R.id.i03,i);
        string_to_int(view,vals_P2,R.id.n03,n);
        string_to_int(view,vals_P2,R.id.g03,g);
        string_to_int(view,vals_P2,R.id.o03,o);
        string_to_int(view,vals_P2,R.id.b04,b);
        string_to_int(view,vals_P2,R.id.i04,i);
        string_to_int(view,vals_P2,R.id.n04,n);
        string_to_int(view,vals_P2,R.id.g04,g);
        string_to_int(view,vals_P2,R.id.o04,o);
        string_to_int(view,vals_P2,R.id.b05,b);
        string_to_int(view,vals_P2,R.id.i05,i);
        string_to_int(view,vals_P2,R.id.n05,n);
        string_to_int(view,vals_P2,R.id.g05,g);
        string_to_int(view,vals_P2,R.id.o05,o);
        initArrayMatrix(table_P2,vals_P2);
    }
    ...
    public void resetPick(View view)
    {
        ...
        TextView freeSpaceTextP2 = view.getRootView().findViewById(R.id.n03);
        if(freeSpaceText.getText() == "FREE\nSPACE")
        {
            freeSpaceText.setTextSize(23);
            freeSpaceTextP2.setTextSize(23);
        }
    }
    ...
    public void click_number(View view)
    {
        ...
        if(mark_indicator == "X" || mark_indicator == "FREE\nSPACE")
        {
            placeholder++;
        }
        else
        {
            ...
            for(int i = 0; i < 5; i ++)	//Nested for loop searches through each value on the 5x5 matrix
            {
                for(int j = 0; j < 5; j ++)
                {
                    ...
                    if(table_P2[i][j] == pick)
                    {
                        table_P2[i][j] = 0;	//changes the matching value on card to 0;
                    }
                }
            ...
            int winR2 = checkForWinRows(table_P2,fullHouse);
            int winC2 = checkForWinCols(table_P2);
            int winD2 = checkForWinDiag(table_P2,xMarks);
            if (fullHouse == 1) {
                if(winR == 1 )
                {
                    setButton(false);
                    ...
                    setButton(false);
                    changeBingoColorP2(view,R.color.redBingo);
                    playWinSound();
                }
            }
            else if (xMarks == 1) {
                ...
                else if(winR2 == 1 || winC2 == 2 || winD2 == 3)
                {
                    setButton(false);
                    changeBingoColorP2(view,R.color.redBingo);
                    playWinSound();
    ...
    public void freeSpaceCondition(View view)
    {
        ...
        TextView freeSpaceP2 = view.getRootView().findViewById(R.id.n03);
        ...
        if(FreeSpace_switch.isChecked())
        {
            ...
            freeSpaceP2.setText("FREE\nSPACE");
            freeSpaceP2.setTextColor(Color.RED);
            freeSpaceP2.setTextSize(12);
    ...
    public void changeBingoColorP2(View view,int colorID) {
